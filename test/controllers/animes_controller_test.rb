...
class AnimesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create anime" do
    assert_difference('Anime.count') do
      post animes_url, params: { anime: { end: @anime.end, name: @anime.name, start: @anime.start } }
    end
  ...
  test "should update anime" do
    patch anime_url(@anime), params: { anime: { end: @anime.end, name: @anime.name, start: @anime.start } }
